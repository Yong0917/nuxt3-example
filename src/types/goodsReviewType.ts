...
export type GoodsPartial<T, U extends keyof T> = Partial<Pick<T, U>> & Omit<T, U>
...
export type ReviewEvaluationList = {
    ...
    evltItemNm: string
    useYn: string
    valueList: Array<ReviewEvaluationValue>
}
...
type GoodsReviewFileDeleteType = GoodsPartial<GoodsReviewContent, 'contFilePathNm'>[]
